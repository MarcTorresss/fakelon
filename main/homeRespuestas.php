  ...
  <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
    <div class="container-fluid" id="menu">
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        ...
        <?php
        echo '<form class="d-flex" method="post" action="homeRespuestas.php?IdOG='.$_GET['IdOG'].'">
...
<main>
  <?php 
    ...
    $sql = 'SELECT * FROM `fak` WHERE idOG=:id AND `NomUser` LIKE "%' . $texto . '%" ORDER BY Data_Publicacio DESC';
    $faks = $db->prepare($sql);
    $faks->execute(array(':id'=>$_GET['IdOG']));
