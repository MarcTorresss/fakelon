...
<main>
  <?php 
    ...
    require_once("./megusta.php");
    $db = openDB();
    $texto = filter_input(INPUT_POST, 'search_text');
    $sql = 'SELECT * FROM `fak` WHERE idOG IS NULL AND `NomUser` LIKE "%' . $texto . '%" ORDER BY Data_Publicacio DESC';
    $faks = $db->prepare($sql);
    $faks->execute();
    ...
    foreach ($faks as $fak) {
      if (isset($fak['Id'])){
        ...
        echo '      <div class="col">
                    ...
                    <img src="../images/corazon.png" id="like" width="40em" height="40em">
                    </a>
                    ...
                    <img src="../images/estrella.png" id="fav" width="50em" height="50em">
                    </a>
                    </div>';
                    }
                    echo '
